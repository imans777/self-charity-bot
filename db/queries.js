...
class Query {
    getActivePlans = () => new Promise((resolve, reject) => {
    ...
    getPlan = (readable_name) => new Promise((resolve, reject) => {
        if (!db()) return reject("db not ready");
    ...
    saveUser = (msg) => new Promise((resolve, reject) => {
        if (!db()) return reject("db not ready");
    ...
    makeDonation = (donation) => new Promise((resolve, reject) => {
        if (!db()) return reject("db not ready");
    ...
    getRemainingStocksForPlan = (plan_id) => new Promise((resolve, reject) => {
        if (!db()) return reject("db not ready");
    ...
    deactivatePlan = (plan_id) => new Promise((resolve, reject) => {
        if (!db()) return reject("db not ready");
